...
def SKindex():
    addon_log("SKindex")
    addDir('[COLOR pink][B]F[/B][/COLOR]ootball [COLOR red][B]H[/B][/COLOR]ighlights','Football Highlights',33,'https://0.s3.envato.com/files/85092779/football_soccer_highlights_after_effects_preview.jpg' ,  FANART,'','','','')
...
#                print channel
                ...
                try:
                    if linkedUrl=='':
                        ...
                        if name == '[COLOR pink][B]L[/B][/COLOR]ive [COLOR red][B]A[/B][/COLOR]ll [COLOR pink][B]S[/B][/COLOR]ports':
