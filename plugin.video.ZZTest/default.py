...
def Main_Menu():
	## Movies ##
	movies_fanart = "https://www.setaswall.com/wp-content/uploads/2018/07/Cricket-Wallpaper-23-1182x888.jpg"
	movies_icon = "https://png.pngtree.com/element_origin_min_pic/00/16/04/25571e1f9b802cd.jpg"
	addDir('folder', 'load_movies', "[COLOR yellow]CRICKET[/COLOR]", "[COLOR yellow]CRICKET[/COLOR]", movies_icon, movies_fanart)
