...
addon = xbmcaddon.Addon('plugin.video.KarbalaTVLive')
...
requestUrl = "https://www.youtube.com/user/karbalachannel/videos?live_view=500&sort=dd&view=0&flow=list"
r = requests.get(requestUrl)
data = r.text
soup = BeautifulSoup(data)

#YouTube Jaffari Center LIVE Stream
liveGetURL = "https://www.youtube.com/user/karbalachannel/live"
