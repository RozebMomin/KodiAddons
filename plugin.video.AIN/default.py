...
def addEmoviesFromSearch(urldata):
    ...
    if urldata["type"]=="decade":
        ...
        url1="https://einthusan.tv/movie/results/?decade=%s&find=Decade&lang=%s&page=%s"%(decadenumber,lang,str(urlpage-1))
        url2="https://einthusan.tv/movie/results/?decade=%s&find=Decade&lang=%s&page=%s"%(decadenumber,lang,str(urlpage))
    elif urldata["type"]=="year":
        yearnumber=urldata["yearnum"]
        url1="https://einthusan.tv/movie/results/?year=%s&find=Year&lang=%s&page=%s"%(yearnumber,lang,str(urlpage-1))
        url2="https://einthusan.tv/movie/results/?year=%s&find=Year&lang=%s&page=%s"%(yearnumber,lang,str(urlpage))
    elif urldata["type"]=="recent":
        url1="https://einthusan.tv/movie/results/?find=Recent&lang=%s&page=%s"%(lang,str(urlpage-1))
        url2="https://einthusan.tv/movie/results/?find=Recent&lang=%s&page=%s"%(lang,str(urlpage))
    elif urldata["type"]=="search":
