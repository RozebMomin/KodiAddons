...
# ----------------------------------------------------------
    def add(self, rootFolder=None):
        menuItems = ["Add folder", "Add DesiTVLive item", "Add xbmc favourite"]
        ...
        if select == 0:
            ...
            common.showInfo('Please browse through DesiTVLive and use \ncontext menu entry "Add to DesiTVLive favourites"')
        elif select == 2:
